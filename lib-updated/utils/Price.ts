import { KLIMA_BCT_PAIR, BCT_USDC_PAIR, KLIMA_MCO2_PAIR, KLIMA_USDC_PAIR, KLIMA_UBO_PAIR, KLIMA_NBO_PAIR, MCO2_USDC_PAIR, NCT_USDC_PAIR } from './Constants'
import { Address, BigDecimal, BigInt, log } from '@graphprotocol/graph-ts'
import { UniswapV2Pair } from '../graph-generated/UniswapV2Pair'
...
export class PriceUtil {
  ...
  static getKLIMA_BCTRate(): BigDecimal {
    return this.getUniV2Rate(KLIMA_BCT_PAIR, this.bctToken.getDecimals(), this.klimaToken.getDecimals(), RATE_FOR_TOKEN.SECOND)
  }
  ...
  static getKLIMA_UBORate(): BigDecimal {
    return this.getUniV2Rate(KLIMA_UBO_PAIR, this.uboToken.getDecimals(), this.klimaToken.getDecimals(), RATE_FOR_TOKEN.SECOND)
  }

  static getKLIMA_NBORate(): BigDecimal {
    return this.getUniV2Rate(KLIMA_NBO_PAIR, this.klimaToken.getDecimals(), this.nboToken.getDecimals(), RATE_FOR_TOKEN.FIRST)
  }
  ...
  static getDiscountedPairCO2(lp_amount: BigInt, pair_address: Address, pairToken0: IToken, pairToken1: IToken): BigDecimal {
  ...
  private static getUniV2Rate(pairAddress: Address, token0Decimals: number, token1Decimals: number, rateForToken: RATE_FOR_TOKEN): BigDecimal {
